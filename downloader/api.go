...
func (c *MangaLibDownloader) GetData(ctx context.Context) (*models.MangaListData, error) {
...
func (c *MangaLibDownloader) GetMeta(ctx context.Context) (*models.Meta, error) {
...
func (c *MangaLibDownloader) GetPopularManga(ctx context.Context) (models.MangaList, error) {
	jsonResp, err := c.GetData(ctx)
	if err != nil {
		return nil, err
	}
...
func (c *MangaLibDownloader) GetSlugs(ctx context.Context) ([]string, error) {
...
func (c *MangaLibDownloader) GetInfo(ctx context.Context, slug string) (*models.MangaInfo, error) {
...
func (c *MangaLibDownloader) GetMangaBranches(ctx context.Context, id int) (models.BranchList, error) {
...
func (c *MangaLibDownloader) GetChapters(ctx context.Context, slug string) (models.ChapterList, error) {
...
func (c *MangaLibDownloader) GetChaptersBranch(ctx context.Context, slug string, branch int) (models.ChapterList, error) {
	chapters := &models.ChaptersData{}
	url := c.createChaptersURL(slug)
...
func (c *MangaLibDownloader) GetChapter(ctx context.Context, slug string, volume, number string) (*models.Chapter, error) {
